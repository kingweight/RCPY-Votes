...
export class TimelineDemoComponent implements OnInit {
    ...
    ngOnInit() {
        this.events1 = [
            ...
            { status: 'Transit Thursdays: Atlantic Terminal/Barclay’s Center', date: 'Thu, October 5, 2023 | 4:00 PM - 8:00 PM', icon: PrimeIcons.ARROWS_ALT, color: '#9E9E9E', description: 'Join us for Transit Thursday where we sign up voters at some of New York busiest subway stations. Mid week is the perfect time to reach as many New Yorkers as possible. You will be signing up new voters and be providing key information about the upcoming November General Election.' },
